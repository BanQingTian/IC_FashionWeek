...
////// Emissive:
                ...
                float2 node_1652 = (i.uv0+node_4446.g*float2(0.1,0.1));
                float4 node_5965 = tex2D(_Tex01,TRANSFORM_TEX(node_1652, _Tex01));
                float2 node_7982 = ((i.uv0+node_4446.g*float2(-0.1,-0.1))*1.25);
                ...
                fixed4 finalRGBA = fixed4(finalColor,1-(i.vertexColor.a*saturate((_OpenMask_var.r+_OpenMask_var.g))));
